...
const classMembersInitial = [
  ...
  { name: 'NURHAYANI', quote: '"Belajar hari ini, memimpin esok hari."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228131/ayaq.jpg', instagram: 'https://www.instagram.com/ayaaqqq___?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
