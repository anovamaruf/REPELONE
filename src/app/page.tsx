...
const classExecutivesInitial = [
  { name: 'NIKITA MULIANI CANDRA', role: 'Ketua Kelas', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228130/niki.jpg', quote: '"Memimpin dengan keteladanan, ketegasan, dan kebersamaan."', instagram: 'https://www.instagram.com/nikii.hdwt?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'SYAMSON TEGUH MULEJATI', role: 'Wakil Ketua Kelas', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228132/samson.jpg', quote: '"Stay calm, tetap solid, dan keep coding!"', instagram: 'https://www.instagram.com/camonson_?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'ZAINAB MANSHUR', role: 'Sekretaris', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228134/zain.jpg', quote: '"Mencatat setiap agenda & momen kelas secara teliti dan rapi."', instagram: 'https://www.instagram.com/x.leepy?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'IDA AYU NYOMAN DWIPA YANTI', role: 'Bendahara', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228131/dayu.jpg', quote: '"Keuangan transparan, jangan lupa bayar uang kas tepat waktu!"', instagram: 'https://www.instagram.com/iandiiy?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'I PUTU ANDRAYUGA PUTRA SUDHANA', role: 'Keamanan', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228130/andra.jpg', quote: '"Menjaga ketertiban dan kenyamanan belajar di kelas."', instagram: 'https://www.instagram.com/andra278857?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'MADU CITRA LESTARI', role: 'Keamanan', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228134/madu.jpg', quote: '"Kedisiplinan dan kekeluargaan adalah kunci keharmonisan."', instagram: 'https://www.instagram.com/du.auric?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
];

const classMembersInitial = [
  { name: 'AHMAD RIZKI FEBRIAN', quote: '"Code modern, solusi cerdas."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228132/riski_febrian.jpg', instagram: 'https://www.instagram.com/rzkyfbran666?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'ASMIRA SALVIA', quote: '"Tetap tersenyum di setiap error syntax."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228131/asmira.jpg', instagram: 'https://www.instagram.com/asmslvia?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'BAIQ IZA NURUL AZKIYA', quote: '"Belajar tanpa henti untuk masa depan."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228133/iza.jpg', instagram: 'https://www.instagram.com/nn_jaaaaaa?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'BINTANG ARASTI', quote: '"Bintang kelas di dunia programming."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228131/bintang.jpg', instagram: 'https://www.instagram.com/intang4rast?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'DIANA SUSIANTO', quote: '"Mewujudkan impian satu per satu."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228132/diana.jpg', instagram: 'https://www.instagram.com/diananaaeaa?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  ...
  { name: 'GHITSA RIZKIKA', quote: '"Semangat dan selalu berikan yang terbaik."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228133/gitsa.jpg', instagram: 'https://www.instagram.com/the.ycallmechaa?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'GUFRAN NAPISS', quote: '"Fokus pada proses dan hasil akhir."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228132/gupron.jpg', instagram: 'https://www.instagram.com/fronnqt?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'I GUSTI BAGUS AGUNG ALIT MAHENDRA', quote: '"Soliditas tanpa batas di XII RPL ONE."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228133/hendra.jpg', instagram: 'https://www.instagram.com/henn_fx?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'I KOMANG ANGGA ADI ARTA', quote: '"Pantang menyerah sebelum program jalan."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228130/angga.jpg', instagram: 'https://www.instagram.com/anggii.hihii?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'I NYOMAN SATIA MAHESA LINGGIH', quote: '"Harmoni dalam kodingan dan pertemanan."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228133/esa.jpg', instagram: 'https://www.instagram.com/esaes_.id?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'I WAYAN EKALAYA', quote: '"Fokus pada cita-cita dan karya."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228132/eka.jpg', instagram: 'https://www.instagram.com/vuydsky?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'JUMAWARNI NASKIA', quote: '"Kebersamaan adalah kunci keberhasilan."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228131/ayaq.jpg', instagram: 'https://www.instagram.com/ayaaqqq___?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'LALU FAHRIZA ALFARIZKY', quote: '"Terus berkembang di era teknologi."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228132/riza.jpg', instagram: 'https://www.instagram.com/rizzzxy_?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  ...
  { name: 'MUHAMMAD ANOVA MA\'RUF', quote: '"Gagal coba lagi, error perbaiki."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228134/m_anova.jpg', instagram: 'https://www.instagram.com/vaamkrff?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'MUHAMMAD AQSHO KHATAMI', quote: '"Konsistensi adalah kunci sukses sejati."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228130/aqso.jpg', instagram: 'https://www.instagram.com/muhmd_aqsho?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'MUHAMMAD RADJADIN', quote: '"Berpikir kritis, bertindak tepat."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228132/radin.jpg', instagram: 'https://www.instagram.com/_rajdn?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'MUHAMMAD WAZIR ISLAMI', quote: '"Mengukir sejarah manis bersama RPL 1."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228133/wazir.jpg', instagram: 'https://www.instagram.com/wazirislm?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'NADIA', quote: '"Jadikan setiap hari penuh makna."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228130/nadia.jpg', instagram: 'https://www.instagram.com/nadiasena._?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'NAMIRA HARDI', quote: '"Kreativitas tanpa batas di kelas RPL."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228130/mira.jpg', instagram: 'https://www.instagram.com/nmiraahrd?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'NURHAYANI', quote: '"Belajar hari ini, memimpin esok hari."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228131/ayaq.jpg', instagram: 'https://www.instagram.com/nrslayting?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'NURISYA PUTRI', quote: '"Tetap rendah hati dan terus belajar."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228131/nuris.jpg', instagram: 'https://www.instagram.com/nrslayting?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'PANJIE PRATAMA PUTRA RAHMAN', quote: '"Teknologi untuk masa depan yang lebih baik."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228131/panjie.jpg', instagram: 'https://www.instagram.com/pnjieprtm?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'PUTRI AYUDIA CHAIRUNNISA', quote: '"Bercita-cita tinggi dan berusaha gigih."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228131/putri.jpg', instagram: 'https://www.instagram.com/puaac_?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'RIZKY ISLAMI PASHYA', quote: '"Sukses butuh proses dan kerja keras."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228132/riski_pashya.jpg', instagram: 'https://www.instagram.com/_rzkykyky?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'SELVAN JULIAN PRATAMA', quote: '"Selalu ada jalan untuk setiap tantangan."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228133/selvan.jpg', instagram: 'https://www.instagram.com/_slpn__?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'SOVIYA KUDUSIYAH', quote: '"Kebaikan kecil berdampak besar."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228133/soviya.jpg', instagram: 'https://www.instagram.com/liyyyliivvv?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'TIARA', quote: '"Terus bersinar bersama teman-teman."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228133/tiara.jpg', instagram: 'https://www.instagram.com/tiiiiiiaaraaaaaaa?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
  { name: 'ZAHRA TUSSITA', quote: '"Manisnya perjuangan akan terasa di akhir."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228134/zahra.jpg', instagram: 'https://www.instagram.com/_zhrotssta_?utm_source=ig_web_button_share_sheet&stkn=ZDNlZDc0MzIxNw==' },
].map((member) => ({
  ...member,
  role: 'Anggota Kelas',
}));
