...
const classMembersInitial = [
  ...
  { name: 'NURHAYANI', quote: '"Belajar hari ini, memimpin esok hari."', avatar: 'https://res.cloudinary.com/fybbrdcq/image/upload/v1789228131/ayaq.jpg', instagram: 'https://instagram.com/' },
